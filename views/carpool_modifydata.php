...
<link rel="stylesheet" href="https://job-qwerrtty.c9users.io/project_test2/views/css/carpool_memberdata.css">
<style type="text/css">
...
<br>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="nickname"id="nickname" placeholder="暱稱"value='' >
